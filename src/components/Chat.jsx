...
export default function Chat({ setScene }) {
    ...
    return (
        <>
            <div className="absolute hidden md:block -bottom-48 -left-36 w-96 h-96">
            ...
            <div className="absolute z-20 text-sm m-6 text-extrabold bottom-0 left-0">
                <span>
                ...
                <a onClick={() => setScene(2)} className="text-xs m- underline">
                    Let's Talk!
                </a>
            </div>
