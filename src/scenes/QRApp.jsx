...
export default function QRApp() {
    ...
    return (
        <div className="h-full w-screen flex flex-row justify-center items-start p-8 overflow-scroll ">
            <div className="max-w-sm w-full bg-white flex flex-col justify-between rounded-2xl p-8">
